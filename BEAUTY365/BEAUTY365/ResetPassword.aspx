<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="BEAUTY365.ResetPassword" %>
        ...
        <form id="form1" runat="server">
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    <i class="fa fa-key"></i>
                    <asp:TextBox ID="txt_OldPassword" runat="server" CssClass="form-control placeholder-no-fix" autocomplete="off" placeholder="Old Password"></asp:TextBox>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="input-icon">
                    <i class="fa fa-key"></i>
                    <asp:TextBox ID="txt_NewPassword" runat="server" type="password" CssClass="form-control placeholder-no-fix" AutoCompleteType="None" autocomplete="off" placeholder="New Password"></asp:TextBox>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label visible-ie8 visible-ie9">Password</label>
                <div class="input-icon">
                    <i class="fa fa-key"></i>
                    <asp:TextBox ID="txt_ConfirmPassword" runat="server" type="password" CssClass="form-control placeholder-no-fix" AutoCompleteType="None" autocomplete="off" placeholder="Confirm Password"></asp:TextBox>
                </div>
            </div>
            <div class="form-actions">
                <asp:Button ID="btn_Reset" runat="server" Text="RESET" CssClass="btn green pull-right" />
            </div>
        </form>
    </div>
